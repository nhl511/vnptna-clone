...
const TransmissionNetWorkInfrastructurePage = async () => {
  const introHeader = await getNewsByCateId({ id: 2167, page: 1, num: 1 });

  const products = await getProductsByServiceCate(2167);
  return (

...
import { Handshake, IdCard, Lock, ThumbsUp, Trophy, User } from "lucide-react";
...
const LoginPage = () => {
  ...
  return (
    <div>
      <div className="bg-[url(/images/loginbg.jpg)] bg-cover bg-center h-[600px] flex items-center">
        <div className="xl:container xl:mx-auto flex justify-between">
          <div className="bg-white w-[380px] px-4 py-8 flex flex-col gap-3">
            ...
            <div className="flex justify-center mb-2">
              <Link
                href=""
                className="text-red-500 font-bold text-sm underline"
              >
          ...
          <div className="bg-white w-[500px] p-4 flex flex-col gap-2 text-[var(--login-btn)]">
            <p>
              - Quý khách hàng chưa có, hoặc quên mật khẩu tra cứu cước vui lòng
              liên hệ tại các điểm giao dịch của <b>VNPT Nghệ An</b> hoặc trực
              tiếp qua nhân viên thu cước để có thông tin.
            </p>
            <p>
              - Bạn có thể xem hướng dẫn cách tra cứu cước{" "}
              <b>VNPT Nghệ An - Hướng dẫn tra cứu cước</b> để hiểu rõ về cách
              tra cứu cước online của VNPT Nghệ An.
            </p>
            <p>
